...
const Aside = ({ id }) => {
  console.log(id);
  return (
    <div class="w-60 invisible md:visible md:h-full md:shadow-md md:bg-gray-100 md:px-1 absolute ">
      <ul class="relative">
        <li class="relative grid">
          <span>Listas</span>
          <Link to={`/eventos/${id}/listas/crear`}>
            <div
              class="flex gap-2 items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out"
